...
#    shap.force_plot(explainer.expected_value, shap_values[0], X.iloc[0, :], matplotlib=True)
    ...
    shap.summary_plot(exp, X)
    shap.summary_plot(exp, X, plot_type="bar")
    #shap.force_plot(exp.expected_value, shap_values[0], X.iloc[0, :], matplotlib=True)
...
#best_features = utils.load_features("/home/tong/fobmResults/Top10_obmfeature_from_DL1024_1099_iteration10000_60percent_unpaired.txt") #10000 iteration  60% train using DL 1024+ 1099 FEATURES; use all top 10 for shap value

best_features = utils.load_features("/home/tong/fobmResults/Top10_obmfeature_from_DL1024_iteration10000_60percent_unpaired.txt") #10000 iteration  60% train using DL 1024 FEATURES; use all top 10 for shap value
